...
class _HomeState extends State<Home>{
  final List<Curso> cursos = <Curso>[new Curso("Java básico",40), 
  ...
  void _inserir(){
    setState(() {
      cursos.insert(0,new Curso(_cursoController.text,int.parse(_cargaHoraria.text)));
    });
  }
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                return Container(
                  ...
                  color: cursos[index].cargaHoraria >= 40? Colors.blue[400]:
                         cursos[index].cargaHoraria >= 30? Colors.blue[100]:
                         Colors.grey,
                  child: Center(
